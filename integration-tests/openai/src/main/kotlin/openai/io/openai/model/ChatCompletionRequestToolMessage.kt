...
@Serializable
public data class ChatCompletionRequestToolMessage(
  ...
  public sealed interface Content {
    ...
    public object Serializer : KSerializer<Content> {
      ...
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.ChatCompletionRequestToolMessage.Content", PolymorphicKind.SEALED) {
