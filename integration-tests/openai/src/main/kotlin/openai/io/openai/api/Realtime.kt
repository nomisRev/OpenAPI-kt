...
import io.openai.model.AudioTranscription
import io.openai.model.MCPTool
import io.openai.model.NoiseReductionType
import io.openai.model.Prompt
import io.openai.model.RealtimeAudioFormats
...
import io.openai.model.RealtimeFunctionTool
...
import io.openai.model.RealtimeTruncation
import io.openai.model.RealtimeTurnDetection
import io.openai.model.ToolChoiceFunction
import io.openai.model.ToolChoiceMCP
import io.openai.model.ToolChoiceOptions
import io.openai.model.VoiceIdsOrCustomVoice
        ...
        public data class Session(
          ...
          public sealed interface MaxOutputTokens {
            ...
            public object Serializer : KSerializer<MaxOutputTokens> {
              ...
              override val descriptor: SerialDescriptor =
                  buildSerialDescriptor("io.openai.api.Realtime.Calls.Post.Body.Session.MaxOutputTokens", PolymorphicKind.SEALED) {
          ...
          public sealed interface ToolChoice {
            ...
            public object Serializer : KSerializer<ToolChoice> {
              ...
              override val descriptor: SerialDescriptor =
                  buildSerialDescriptor("io.openai.api.Realtime.Calls.Post.Body.Session.ToolChoice", PolymorphicKind.SEALED) {
          ...
          public sealed interface Tools {
            ...
            public object Serializer : KSerializer<Tools> {
              ...
              override val descriptor: SerialDescriptor =
                  buildSerialDescriptor("io.openai.api.Realtime.Calls.Post.Body.Session.Tools", PolymorphicKind.SEALED) {
          ...
          public sealed interface Tracing {
            ...
            public object Serializer : KSerializer<Tracing> {
              ...
              override val descriptor: SerialDescriptor =
                  buildSerialDescriptor("io.openai.api.Realtime.Calls.Post.Body.Session.Tracing", PolymorphicKind.SEALED) {
