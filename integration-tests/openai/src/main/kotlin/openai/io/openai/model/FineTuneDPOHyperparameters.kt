 ...
 */
@Serializable
public data class FineTuneDPOHyperparameters(
  public val beta: Beta? = null,
  ...
  public sealed interface BatchSize {
    ...
    public object Serializer : KSerializer<BatchSize> {
      ...
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.FineTuneDPOHyperparameters.BatchSize", PolymorphicKind.SEALED) {
   ...
   *
   */
  @Serializable(with = Beta.Serializer::class)
  public sealed interface Beta {
    @Serializable
    public enum class Auto(
      public val `value`: String,
    ) : Beta {
    ...
    public object Serializer : KSerializer<Beta> {
      @OptIn(
        InternalSerializationApi::class,
        ExperimentalSerializationApi::class,
      )
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.FineTuneDPOHyperparameters.Beta", PolymorphicKind.SEALED) {
        element("Auto", Auto.serializer().descriptor)
        element("CaseDouble", Double.serializer().descriptor)
      }

      override fun deserialize(decoder: Decoder): Beta {
        val value = decoder.decodeSerializableValue(JsonElement.serializer())
        val json = requireNotNull(decoder as? JsonDecoder) { "Complex unions currently only supported for Json" }.json
        return json.attemptDeserialize(
          value,
      ...
      override fun serialize(encoder: Encoder, `value`: Beta) {
        when(value) {
          is Auto -> encoder.encodeSerializableValue(Auto.serializer(), value)
  ...
  public sealed interface LearningRateMultiplier {
    ...
    public object Serializer : KSerializer<LearningRateMultiplier> {
      ...
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.FineTuneDPOHyperparameters.LearningRateMultiplier", PolymorphicKind.SEALED) {
        element("Auto", Auto.serializer().descriptor)
        element("CaseDouble", Double.serializer().descriptor)
      }
  ...
  public sealed interface NEpochs {
    ...
    public object Serializer : KSerializer<NEpochs> {
      ...
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.FineTuneDPOHyperparameters.NEpochs", PolymorphicKind.SEALED) {
        element("Auto", Auto.serializer().descriptor)
        element("CaseLong", Long.serializer().descriptor)
      }
