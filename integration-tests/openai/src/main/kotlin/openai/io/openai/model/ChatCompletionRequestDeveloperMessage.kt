 ...
 */
@Serializable
public data class ChatCompletionRequestDeveloperMessage(
  ...
  public sealed interface Content {
    ...
    public object Serializer : KSerializer<Content> {
      ...
      override val descriptor: SerialDescriptor =
          buildSerialDescriptor("io.openai.model.ChatCompletionRequestDeveloperMessage.Content", PolymorphicKind.SEALED) {
