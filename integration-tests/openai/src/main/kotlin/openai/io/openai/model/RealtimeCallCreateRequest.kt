  ...
  public data class Session(
    ...
    public sealed interface MaxOutputTokens {
      ...
      public object Serializer : KSerializer<MaxOutputTokens> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.RealtimeCallCreateRequest.Session.MaxOutputTokens", PolymorphicKind.SEALED) {
    ...
    public sealed interface ToolChoice {
      ...
      public object Serializer : KSerializer<ToolChoice> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.RealtimeCallCreateRequest.Session.ToolChoice", PolymorphicKind.SEALED) {
    ...
    public sealed interface Tools {
      ...
      public object Serializer : KSerializer<Tools> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.RealtimeCallCreateRequest.Session.Tools", PolymorphicKind.SEALED) {
    ...
    public sealed interface Tracing {
      ...
      public object Serializer : KSerializer<Tracing> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.RealtimeCallCreateRequest.Session.Tracing", PolymorphicKind.SEALED) {
