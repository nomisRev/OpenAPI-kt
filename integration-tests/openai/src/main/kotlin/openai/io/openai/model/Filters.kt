  ...
  public data class ComparisonFilter(
    ...
    public sealed interface Value {
      ...
      public sealed interface StringOrDouble {
        ...
        public object Serializer : KSerializer<StringOrDouble> {
          ...
          override val descriptor: SerialDescriptor =
              buildSerialDescriptor("io.openai.model.Filters.ComparisonFilter.Value.StringOrDouble", PolymorphicKind.SEALED) {
      ...
      public object Serializer : KSerializer<Value> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.Filters.ComparisonFilter.Value", PolymorphicKind.SEALED) {
          element("CaseString", String.serializer().descriptor)
          element("CaseDouble", Double.serializer().descriptor)
  ...
  public data class CompoundFilter(
    ...
    public sealed interface Filters {
        ...
        public sealed interface Value {
          ...
          public sealed interface StringOrDouble {
            ...
            public object Serializer : KSerializer<StringOrDouble> {
              ...
              override val descriptor: SerialDescriptor =
                  buildSerialDescriptor("io.openai.model.Filters.CompoundFilter.Filters.ComparisonFilter.Value.StringOrDouble", PolymorphicKind.SEALED) {
                element("CaseString", String.serializer().descriptor)
                element("CaseDouble", Double.serializer().descriptor)
              }
          ...
          public object Serializer : KSerializer<Value> {
            ...
            override val descriptor: SerialDescriptor =
                buildSerialDescriptor("io.openai.model.Filters.CompoundFilter.Filters.ComparisonFilter.Value", PolymorphicKind.SEALED) {
              element("CaseString", String.serializer().descriptor)
              element("CaseDouble", Double.serializer().descriptor)
              element("CaseBoolean", Boolean.serializer().descriptor)
              element("CaseStringOrDoubleList", ListSerializer(StringOrDouble.serializer()).descriptor)
      ...
      public object Serializer : KSerializer<Filters> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.openai.model.Filters.CompoundFilter.Filters", PolymorphicKind.SEALED) {
        ...
        override fun deserialize(decoder: Decoder): Filters {
          ...
          when(tag) {
            ...
            else -> throw SerializationException("Unknown tag: " + tag + " for io.openai.model.Filters.CompoundFilter.Filters")
          }
        }
  ...
  public object Serializer : KSerializer<Filters> {
    ...
    override fun deserialize(decoder: Decoder): Filters {
      ...
      when(tag) {
        ...
        else -> throw SerializationException("Unknown tag: " + tag + " for io.openai.model.Filters")
      }
    }
