...
public sealed interface RepositoryRule {
  @Serializable
  @SerialName("creation")
  public data object Creation : RepositoryRule
  ...
  @Serializable
  @SerialName("deletion")
  public data object Deletion : RepositoryRule

  @Serializable
  @SerialName("required_linear_history")
  public data object RequiredLinearHistory : RepositoryRule
  ...
  public data object RequiredSignatures : RepositoryRule
  ...
  public data object NonFastForward : RepositoryRule
