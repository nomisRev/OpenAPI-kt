 ...
 */
@Serializable(with = OrgRulesetConditionsWrite.Serializer::class)
public sealed interface OrgRulesetConditionsWrite {
  /**
  ...
  public data class RepositoryPropertyAndRefName(
    ...
    public data class RepositoryProperty(
      public val include: List<RepositoryRulesetConditionsRepositoryPropertySpecWrite>? = null,
      public val exclude: List<RepositoryRulesetConditionsRepositoryPropertySpecWrite>? = null,
    )
  }

  public object Serializer : KSerializer<OrgRulesetConditionsWrite> {
    @OptIn(
      InternalSerializationApi::class,
      ExperimentalSerializationApi::class,
    )
    override val descriptor: SerialDescriptor =
        buildSerialDescriptor("io.github.model.OrgRulesetConditionsWrite", PolymorphicKind.SEALED) {
    ...
    override fun deserialize(decoder: Decoder): OrgRulesetConditionsWrite {
    ...
    override fun serialize(encoder: Encoder, `value`: OrgRulesetConditionsWrite) {
      when(value) {
