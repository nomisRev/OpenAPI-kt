...
@Serializable
public sealed interface RepositoryRuleWrite {
  @Serializable
  @SerialName("creation")
  public data object Creation : RepositoryRuleWrite
  ...
  @Serializable
  @SerialName("deletion")
  public data object Deletion : RepositoryRuleWrite

  @Serializable
  @SerialName("required_linear_history")
  public data object RequiredLinearHistory : RepositoryRuleWrite
  ...
  public data object RequiredSignatures : RepositoryRuleWrite
  ...
  public value class PullRequest(
    ...
    public data class Parameters(
      ...
      public val requiredReviewers:
          List<RepositoryRuleParamsRequiredReviewerConfigurationWrite>? = null,
    ) {
      @Serializable
  ...
  public value class RequiredStatusChecks(
    ...
    public data class Parameters(
      ...
      @SerialName("required_status_checks")
      public val requiredStatusChecks: List<RepositoryRuleParamsStatusCheckConfigurationWrite>,
  ...
  public data object NonFastForward : RepositoryRuleWrite
  ...
  public value class Workflows(
    ...
    public data class Parameters(
      @SerialName("do_not_enforce_on_create")
      public val doNotEnforceOnCreate: Boolean? = null,
      public val workflows: List<RepositoryRuleParamsWorkflowFileReferenceWrite>,
    )
  }
  ...
  public value class CodeScanning(
    ...
    public value class Parameters(
      ...
      public val codeScanningTools: List<RepositoryRuleParamsCodeScanningToolWrite>,
    )
  }
