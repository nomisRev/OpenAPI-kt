...
data class CopilotDotcomChat(
    ...
    object Serializer : KSerializer<CopilotDotcomChat> {
        ...
        override fun serialize(encoder: Encoder, value: CopilotDotcomChat) {
            ...
            return encoder.encodeSerializableValue(
                ...
                buildJsonObject {
                    ...
                    put("models", json.encodeToJsonElement(ListSerializer(Models.serializer()).nullable, value.models))
        ...
        override fun deserialize(decoder: Decoder): CopilotDotcomChat {
            ...
            val names = setOf("total_engaged_users", "models")
            ...
            return CopilotDotcomChat(
                ...
                models = if(element.containsKey("models")) json.decodeFromJsonElement(ListSerializer(Models.serializer()).nullable, element["models"]!!) else null,
