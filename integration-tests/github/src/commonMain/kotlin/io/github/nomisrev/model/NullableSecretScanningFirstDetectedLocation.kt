...
sealed interface NullableSecretScanningFirstDetectedLocation {
    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationCommit(val value: SecretScanningLocationCommit) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationWikiCommit(val value: SecretScanningLocationWikiCommit) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationIssueTitle(val value: SecretScanningLocationIssueTitle) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationIssueBody(val value: SecretScanningLocationIssueBody) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationIssueComment(val value: SecretScanningLocationIssueComment) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationDiscussionTitle(val value: SecretScanningLocationDiscussionTitle) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationDiscussionBody(val value: SecretScanningLocationDiscussionBody) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationDiscussionComment(val value: SecretScanningLocationDiscussionComment) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationPullRequestTitle(val value: SecretScanningLocationPullRequestTitle) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationPullRequestBody(val value: SecretScanningLocationPullRequestBody) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationPullRequestComment(val value: SecretScanningLocationPullRequestComment) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationPullRequestReview(val value: SecretScanningLocationPullRequestReview) : NullableSecretScanningFirstDetectedLocation

    @Serializable
    @JvmInline
    value class CaseSecretScanningLocationPullRequestReviewComment(val value: SecretScanningLocationPullRequestReviewComment) : NullableSecretScanningFirstDetectedLocation

    object Serializer : KSerializer<NullableSecretScanningFirstDetectedLocation> {
        @OptIn(InternalSerializationApi::class, ExperimentalSerializationApi::class)
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("io.github.nomisrev.model.NullableSecretScanningFirstDetectedLocation", PolymorphicKind.SEALED) {
        ...
        override fun serialize(encoder: Encoder, value: NullableSecretScanningFirstDetectedLocation) = when(value) {
