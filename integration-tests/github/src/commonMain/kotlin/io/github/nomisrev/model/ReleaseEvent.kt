...
@Serializable
data class ReleaseEvent(val action: String, val release: Release) {
    @Serializable
    data class Release(
        val url: String,
        ...
        @SerialName("is_short_description_html_truncated") val isShortDescriptionHtmlTruncated: Boolean? = null,
        @SerialName("short_description_html") val shortDescriptionHtml: String? = null,
    )
}
