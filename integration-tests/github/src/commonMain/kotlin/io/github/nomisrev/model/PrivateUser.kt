...
data class PrivateUser(
    ...
    @SerialName("private_gists") val privateGists: Long,
    @SerialName("total_private_repos") val totalPrivateRepos: Long,
    @SerialName("owned_private_repos") val ownedPrivateRepos: Long,
    @SerialName("disk_usage") val diskUsage: Long,
