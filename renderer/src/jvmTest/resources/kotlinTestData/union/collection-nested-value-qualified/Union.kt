package union.collection.nested.value.qualified.model
...
sealed interface Union {
    @Serializable
    @JvmInline
    value class Names(val value: List<Name>) : Union {
        @Serializable
        @JvmInline
    ...
    object Serializer : KSerializer<Union> {
        ...
        override val descriptor: SerialDescriptor =
            buildSerialDescriptor("union.collection.nested.value.qualified.model.Union", PolymorphicKind.SEALED) {
