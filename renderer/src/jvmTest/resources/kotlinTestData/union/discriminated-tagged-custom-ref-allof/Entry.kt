package io.github.nomisrev.render.test.union.discriminated.tagged.custom.ref.allof
...
public sealed interface Entry {
  ...
  public object Serializer : KSerializer<Entry> {
    ...
    override val descriptor: SerialDescriptor =
        buildSerialDescriptor("io.github.nomisrev.render.test.union.discriminated.tagged.custom.ref.allof.Entry", PolymorphicKind.SEALED) {
    ...
    override fun deserialize(decoder: Decoder): Entry {
      ...
      when(tag) {
        ...
        else -> throw SerializationException("Unknown tag: " + tag + " for io.github.nomisrev.render.test.union.discriminated.tagged.custom.ref.allof.Entry")
      }
    }
