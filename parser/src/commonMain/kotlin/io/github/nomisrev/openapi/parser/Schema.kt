...
public data class Schema(
    ...
    public companion object {
        ...
        public fun fromYaml(yaml: String): Schema =
            OpenAPI.Yaml.decodeFromString(serializer(), yaml)
    }
                ...
                when (decoder) {
                    ...
                    is YamlInput -> {
                        when (val node = decoder.decodeSerializableValue(YamlNode.serializer())) {
                            ...
                            is YamlScalar -> Basic.fromString(node.content)
    ...
    override fun toString(): String = JSON_NO_NULL.encodeToString(serializer(), this)
}

private val JSON_NO_NULL = Json { explicitNulls = false }