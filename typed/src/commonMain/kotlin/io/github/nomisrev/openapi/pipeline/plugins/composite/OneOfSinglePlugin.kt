...
object OneOfSinglePlugin : SchemaTransformerPlugin {
    override val key: PluginKey = PluginKeys.OneOfSingle
    ...
    override suspend fun transform(
        ...
        if (oneOf.size != 1) return null

        oneOf.single().toModel(schema.name, context)
    }
}
