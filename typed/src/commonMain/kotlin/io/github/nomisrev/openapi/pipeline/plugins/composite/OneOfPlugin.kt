...
object OneOfPlugin : SchemaTransformerPlugin {
    override val key: PluginKey = PluginKeys.OneOf
    ...
    override suspend fun transform(
        ...
        val oneOf = schema.schema.oneOf ?: return null
        if (oneOf.isEmpty()) return null

        schema.buildOneOf(context, oneOf)
    }
}
