...
public value class StatusCode(public val code: Int) {
  ...
  public companion object {
    ...
    public fun orThrow(code: Int): StatusCode {
      check(code in 100..599) { "Status code outside of the allowed range 100-599: $code" }
      return StatusCode(code)
    }

    public fun orNull(code: Int): StatusCode? =
      if (code < 100 || code > 599) null else StatusCode(code)
