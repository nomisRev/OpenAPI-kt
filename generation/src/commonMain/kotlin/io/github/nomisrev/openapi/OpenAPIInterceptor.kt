...
//                }
                ...
                pSchema.enum != null -> pSchema.singleDefaultOrNull()?.let { DefaultArgument.Enum(model, pContext, it) }
                pSchema.oneOf != null ->
        ...
        public override fun OpenAPISyntax.toPrimitive(
            context: NamingContext,
            schema: Schema,
            basic: Type.Basic
        ): Model =
        ...
        public override fun OpenAPISyntax.type(
            ...
            is Type.Array -> when {
                ...
                }, emptyList()) // Only supports basic types
            }
        ...
        private fun <A : Model> OpenAPISyntax.toUnion(
            ...
            transform: (NamingContext, List<Model.Union.UnionEntry>, List<Model>) -> A
        ): A {
            return transform(context, subtypes.map { ref ->
                ...
                ref.getOrNull()?.toModel(toUnionCaseContext(context, ref))
            })
        }
